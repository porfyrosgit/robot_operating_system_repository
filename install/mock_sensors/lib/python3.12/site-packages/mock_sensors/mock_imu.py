...
#msg.orientation.x: reach the 'x' value. the fixed name for the axis within that rotation inside the imu object
        ...
        #msg.orientation.y = random.uniform(-1.0, 1.0)  # mock orientation y
        #msg.orientation.z = random.uniform(-1.0, 1.0)  # mock orientation z
        #msg.angular_velocity.x = random.uniform(-0.5, 0.5)  # mock angular velocity x
